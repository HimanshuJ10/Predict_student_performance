...
-- Started on 2025-08-19 12:11:09
...
-- Name: studentmat; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.studentmat (
    school character varying(10),
    sex character(1),
    age integer,
    address character(1),
    famsize character varying(5),
    pstatus character(1),
    medu integer,
    fedu integer,
    mjob character varying(20),
    fjob character varying(20),
    reason character varying(20),
    guardian character varying(20),
    traveltime integer,
    studytime integer,
    failures integer,
    schoolsup character varying(5),
    famsup character varying(5),
    paid character varying(5),
    activities character varying(5),
    nursery character varying(5),
    higher character varying(5),
    internet character varying(5),
    romantic character varying(5),
    famrel integer,
    freetime integer,
    goout integer,
    dalc integer,
...
ALTER TABLE public.studentmat OWNER TO postgres;

--
-- TOC entry 218 (class 1259 OID 32778)
-- Name: studentpor; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.studentpor (
    school character varying(10),
    sex character(1),
    age integer,
    address character(1),
...
ALTER TABLE public.studentpor OWNER TO postgres;

--
-- TOC entry 4789 (class 0 OID 32775)
-- Dependencies: 217
-- Data for Name: studentmat; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.studentmat (school, sex, age, address, famsize, pstatus, medu, fedu, mjob, fjob, reason, guardian, traveltime, studytime, failures, schoolsup, famsup, paid, activities, nursery, higher, internet, romantic, famrel, freetime, goout, dalc, walc, health, absences, g1, g2, g3) FROM stdin;
...
--
-- TOC entry 4790 (class 0 OID 32778)
-- Dependencies: 218
-- Data for Name: studentpor; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.studentpor (school, sex, age, address, famsize, pstatus, medu, fedu, mjob, fjob, reason, guardian, traveltime, studytime, failures, schoolsup, famsup, paid, activities, nursery, higher, internet, romantic, famrel, freetime, goout, dalc, walc, health, absences, g1, g2, g3) FROM stdin;
...
-- Completed on 2025-08-19 12:11:09
